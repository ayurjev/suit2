...
describe('Application', () => {
    ...
    it('should render component correctly according to the data', () => {
        ...
        let component = app.createComponent(TestComponent, {user: {name: "Andrey", age: 28}});
    ...
    it('should use default value for variable if there is required variable is not present in data', () => {
        ...
        let component = app.createComponent(TestComponent, {user: {name: "Andrey"}});
    ...
    it('should support full and short syntax for if/else (multiline)', () => {
        ...
        let component1 = app.createComponent(TestComponent);
    ...
    it('should support include syntax', () => {
        ...
        let component = app.createComponent(TestComponent, {user: {name: "Andrey", age: 28}}, {"inclusion_name": TestInclusion});
    ...
    it('should support include syntax with variables', () => {
        ...
        let component = app.createComponent(TestComponent, {}, {"digit": DigitComponent});
    ...
    it('should support include syntax with dynamic inclusion name', () => {
        ...
        let component = app.createComponent(TestComponent, {"includeName": "digit"}, {"digit": DigitComponent});
    ...
    it('should support rebuild syntax', () => {
        ...
        let baseComponent = app.createComponent(TestComponent, {}, {"base_template": BaseComponent});
        assert.equal('PREFIX-DEFAULT-CONTENT-SUFFIX-ENDING', baseComponent.render());

        let rebasedComponent = app.createComponent(RebasedComponent, {}, {"base_template": BaseComponent});
    ...
    it('should support rebuild syntax with curly braces instead of quotes and other expressions inside', () => {
        ...
        let rebasedComponent = app.createComponent(
            RebasedComponent, {},
